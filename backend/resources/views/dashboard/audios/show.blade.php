                ...
                <div class="p-6">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-2 text-sm font-semibold text-gray-900">Analyse en cours</h3>
                            <p class="mt-1 text-sm text-gray-500">L'analyse de cet audio est en cours de traitement.</p>
                        </div>
                    @endif
                </div>
            </div>
