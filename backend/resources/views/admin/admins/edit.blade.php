<x-admin-layout pageTitle="Modifier l'Administrateur : {{ $user->name }}">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Modifiez les informations et permissions de l'administrateur</p>
                    </div>
            ...
            <form action="{{ route('admin.admins.update', $user) }}" method="POST" class="p-6">
                @csrf
                @method('PATCH')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="role" 
                            ...
                            <option value="super_admin" {{ old('role', $user->role) === 'super_admin' ? 'selected' : '' }}>Super Admin (toutes les permissions)</option>
                        </select>
